...
//        Assert.assertTrue(dashboard.clickOnChargers());
    ...
    public void TC_6_CheckEditButtonUnderActionColumn() throws InterruptedException {
        ...
        Assert.assertTrue(list.verifyActionColumnOccupiedWithEditButton("Action",4));
    }
...
//        Assert.assertTrue(chargerListPropertyAdmin.ClickButton(ChargerListPropertyAdmin.LoadMoreButton,2000));
    ...
    public void TC_8_VerifyChargerPageHasResetToDefaultvalueAfterPressingCrossButton() throws InterruptedException {
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard=new Dashboard(driver);
        SearchCompany searchcompany=new SearchCompany(driver);
        EditCompany editCompany=new EditCompany(driver);
...
//        loginPage.VerifyValidLogin();
    ...
    public void TC_82_CheckEditedDataFromDrawerInAuditLog() throws InterruptedException{
        ...
        Assert.assertTrue(dashboard.clickOnPropertiesFromLeftMenu());
        Assert.assertTrue(dashboard.clickOnChargers());
        Assert.assertTrue(editChargerCosAdminUpdated.writeInSearchBar(ChargerListPropertyAdmin.SearchChargerField,"Raw charger 0",1000));
        Assert.assertTrue(createcharger.clickButton(CreateCharger.searchChargerBtn,1000));
        Assert.assertTrue(createcharger.clickButton(CosAdminChargerList.EditButton,1000));
...
//        loginPage.VerifyValidLogin();
    ...
    public void TC_91_CheckUpdatedChargingRateIsShowingCorrectlyAfterScanningCharger() throws InterruptedException, IOException, UnsupportedFlavorException {
        ...
        Assert.assertTrue(dashboard.clickOnPropertiesFromLeftMenu());
        Assert.assertTrue(dashboard.clickOnChargers());
        Assert.assertTrue(editChargerCosAdminUpdated.writeInSearchBar(ChargerListPropertyAdmin.SearchChargerField,"Selenium 5", 1000));
        Assert.assertTrue(chargerListPropertyAdmin.ClickButton(ChargerListPropertyAdmin.searchargerbtn,1500));
        Assert.assertTrue(chargerListPropertyAdmin.ClickButton(CosAdminChargerList.EditButton,1000));
...
//    }
    ...
    //Property admin charger list starts here


    @Test(priority = 135)//Done
    @TestParameters(testCaseId = {"TC-3"})
    public void TC_3_CheckBlankContentUnderEachColumnInPropertyAdmin() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard = new Dashboard(driver);
        CreateCharger createcharger = new CreateCharger(driver);
    ...
    @Test(priority = 136)//Done
    @TestParameters(testCaseId = {"TC-4"})
    public void TC_4_CheckTheLocationColumnWhenAdminDidNotAssignAnyChargerToLocationInPropertyAdmin() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard=new Dashboard(driver);
        ChargerListPropertyAdmin chargerListPropertyAdmin = new ChargerListPropertyAdmin(driver);
    ...
    @TestParameters(testCaseId = {"TC-5"})
    public void TC_5_CheckUpdatedLocationInPropertyAdmin() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard=new Dashboard(driver);
        CreateCharger createCharger = new CreateCharger(driver);
...
//        Assert.assertTrue(chargerListPropertyAdmin.ClickButton(ChargerListPropertyAdmin.SelectedLocationFromOption,2000));
    ...
    @TestParameters(testCaseId = {"TC-9"})
    public void TC_9_CheckLoadMoreButtonInCompanyPanel() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard = new Dashboard(driver);
        ChargerListPropertyAdmin chargerListPropertyAdmin = new ChargerListPropertyAdmin(driver);
...
//        Assert.assertTrue(chargerListPropertyAdmin.ClickButton(ChargerListPropertyAdmin.LoadMoreButton,2000));
    ...
    @TestParameters(testCaseId = {"TC-10"})
    public void TC_10_CheckLoadMoreButtonWithTextCompanyPanel() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard = new Dashboard(driver);
        ChargerListPropertyAdmin chargerListPropertyAdmin = new ChargerListPropertyAdmin(driver);
...
//        Assert.assertTrue(chargerListPropertyAdmin.ClickButton(ChargerListPropertyAdmin.LoadMoreButton,2000));
    ...
    @TestParameters(testCaseId = {"TC-12"})
    public void TC_12_CheckActualNumberOfChargerWithLeftSideOfLoadMoreButtonCompanyPanel() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard = new Dashboard(driver);
        ChargerListPropertyAdmin chargerListPropertyAdmin = new ChargerListPropertyAdmin(driver);
    ...
    @TestParameters(testCaseId = {"TC-11"})
    public void TC_11_VerifyActualNumberOfChargerWithTableChargerCompanyPanel() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard = new Dashboard(driver);
        ChargerListPropertyAdmin chargerListPropertyAdmin = new ChargerListPropertyAdmin(driver);
    ...
    @TestParameters(testCaseId = {"TC-13"})
    public void TC_13_CheckWhatHappensWhenPAdminClicksOnTheLoadMoreButtonCompanyPanel() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard = new Dashboard(driver);
        ChargerListPropertyAdmin chargerListPropertyAdmin = new ChargerListPropertyAdmin(driver);
    ...
    @TestParameters(testCaseId = {"TC-14"})
    public void TC_14_CheckTheChargerCountOnTopOfTheTableCompanyPanel () throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        LoginPage loginPage = new LoginPage(driver);
        Dashboard dashboard = new Dashboard(driver);
        ChargerListPropertyAdmin chargerListPropertyAdmin = new ChargerListPropertyAdmin(driver);
